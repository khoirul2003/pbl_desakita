...
class DesaPayHistoryScreen extends StatelessWidget {
  ...
  */
  Widget _buildCurvedHeader(BuildContext context) {
    // Karena ini adalah halaman riwayat dan bukan bagian dari IndexedStack utama,
    // kita asumsikan selalu ada tombol kembali, kecuali jika ini adalah root pertama.
    final bool canPop = Navigator.of(context).canPop();
    
    // Memberikan padding atas untuk menampung status bar
    final double topPadding = MediaQuery.of(context).padding.top;

    return Container(
      // Atur padding atas manual agar menyesuaikan status bar
      padding: EdgeInsets.only(left: 20, right: 20, top: topPadding + 12, bottom: 20),
      decoration: BoxDecoration(
        color: primaryColor,
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              "Riwayat Transaksi Desapay",
              textAlign: canPop ? TextAlign.left : TextAlign.center,
              maxLines: 1, // Memastikan judul menyamping
  ...
  */
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // MENGHAPUS APPBAR DAN MENGGANTI BODY DENGAN COLUMN
      // appBar: AppBar(
      ...
      body: Column(
        children: [
          ...
          // 2. BODY UTAMA (Dibungkus Expanded)
          Expanded(
